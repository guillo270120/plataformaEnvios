...
import 'crear_paquete_page_model.dart';
export 'crear_paquete_page_model.dart';

class CrearPaquetePageWidget extends StatefulWidget {
  const CrearPaquetePageWidget({Key? key}) : super(key: key);

  @override
  _CrearPaquetePageWidgetState createState() => _CrearPaquetePageWidgetState();
}

class _CrearPaquetePageWidgetState extends State<CrearPaquetePageWidget> {
  late CrearPaquetePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearPaquetePageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'crearPaquetePage'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CREAR_PAQUETE_crearPaquetePage_ON_INIT_S');
      logFirebaseEvent('crearPaquetePage_update_app_state');
      setState(() {
        FFAppState().pagina = 'Crear paquete';
      });
    });
      ...
      builder: (context) => StreamBuilder<List<ConfiguracionLocalRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<ConfiguracionLocalRecord>
              crearPaquetePageConfiguracionLocalRecordList = snapshot.data!;
          final crearPaquetePageConfiguracionLocalRecord =
              crearPaquetePageConfiguracionLocalRecordList.isNotEmpty
                  ? crearPaquetePageConfiguracionLocalRecordList.first
                  : null;
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'CREAR_PAQUETE_GUARDAR_PAQUETE_BTN_ON_TAP');
                                      ...
                                      await PaquetesRecord.collection
                                        ...
                                        'filtros':
                                            crearPaquetePageConfiguracionLocalRecord!
                                                .administradoresUuid,
                                      });
