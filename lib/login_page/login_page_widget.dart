...
class _LoginPageWidgetState extends State<LoginPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('loginPage_update_app_state');
      setState(() {
    ...
    _model.crearEmailController ??= TextEditingController();
    _model.crearPassController ??= TextEditingController();
    _model.crearPassConController ??= TextEditingController();
    _model.crearNomController ??= TextEditingController();
          ...
          child: StreamBuilder<List<ConfiguracionLocalRecord>>(
            stream: queryConfiguracionLocalRecord(
              queryBuilder: (configuracionLocalRecord) =>
                  configuracionLocalRecord.where('nombre_plataforma',
                      isEqualTo: FFAppState().nombrePlataforma),
              singleRecord: true,
            ),
            builder: (context, snapshot) {
              ...
              List<ConfiguracionLocalRecord>
                  containerConfiguracionLocalRecordList = snapshot.data!;
                    ...
                    children: [
                      if (responsiveVisibility(
                        ...
                        ClipRRect(
                          ...
                          child: Image.network(
                            containerConfiguracionLocalRecord!.logo,
                            width: 300.0,
                            height: 200.0,
                            fit: BoxFit.contain,
                          ),
                                        ...
                                        children: [
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LOGIN_PAGE_PAGE_Text_fvbk7uaw_ON_TAP');
                                                      logFirebaseEvent(
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'LOGIN_INICIAR_SESION_BTN_ON_TAP');
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.crearPassController,
                                              obscureText:
                                                  !_model.crearPassVisibility,
                                              decoration: InputDecoration(
                                                labelText: 'Contraseña',
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                          ...
                                          Padding(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.crearPassConController,
                                              obscureText: !_model
                                                  .crearPassConVisibility,
                                              decoration: InputDecoration(
                                                labelText:
                                              ...
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium,
                                              validator: _model
                                                  .crearPassConControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                          Padding(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LOGIN_PAGE_PAGE_Text_dn4fz0zk_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Text_update_app_state');
                                                      setState(() {
                                                        FFAppState().login =
                                          ...
                                          Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'LOGIN_PAGE_PAGE_CREAR_CUENTA_BTN_ON_TAP');
                                                logFirebaseEvent('Button_auth');
                                                GoRouter.of(context)
                                                    .prepareAuthEvent();
                                                if (_model.crearPassController
                                                        .text !=
                                                    _model
                                                        .crearPassConController
                                                        .text) {
                                                  ScaffoldMessenger.of(context)
                                                      .showSnackBar(
                                                    SnackBar(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                    .emailAddressLoginMobileController,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: 'Email ',
                                                ...
                                                decoration: InputDecoration(
                                                  ...
                                                  suffixIcon: InkWell(
                                                    ...
                                                    focusNode: FocusNode(
                                                        skipTraversal: true),
                                                    child: Icon(
                                                      _model.passwordLoginMobileVisibility
                                                          ? Icons
                                                              .visibility_outlined
                                                          : Icons
                                                              .visibility_off_outlined,
                                            ...
                                            Padding(
                                              ...
                                              child: FFButtonWidget(
                                                onPressed: () async {
                                                  logFirebaseEvent(
                                                      'LOGIN_Button-Login_mobile_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Button-Login_mobile_auth');
                                                  GoRouter.of(context)
                                                      .prepareAuthEvent();
