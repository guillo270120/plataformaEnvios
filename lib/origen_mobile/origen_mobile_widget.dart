...
import 'origen_mobile_model.dart';
export 'origen_mobile_model.dart';

class OrigenMobileWidget extends StatefulWidget {
  const OrigenMobileWidget({Key? key}) : super(key: key);

  @override
  _OrigenMobileWidgetState createState() => _OrigenMobileWidgetState();
}

class _OrigenMobileWidgetState extends State<OrigenMobileWidget> {
  late OrigenMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrigenMobileModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'origenMobile'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<DireccionesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DireccionesRecord> origenMobileDireccionesRecordList =
            snapshot.data!;
                      ...
                      return Column(
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'ORIGEN_MOBILE_PAGE_Icon_g4bn5f6u_ON_TAP');
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'ORIGEN_MOBILE_CREAR_ENVIO_BTN_ON_TAP');
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'ORIGEN_MOBILE_PAGE_Row_y6ombvjy_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_navigate_to');
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'ORIGEN_MOBILE_PAGE_Row_h38z9qan_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_navigate_to');
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'ORIGEN_MOBILE_PAGE_Row_g0q83014_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_navigate_to');
                                            ...
                                            Padding(
                                              ...
                                              child: InkWell(
                                                ...
                                                onTap: () async {
                                                  logFirebaseEvent(
                                                      'ORIGEN_MOBILE_PAGE_Row_w45fnzwe_ON_TAP');
                                                  logFirebaseEvent(
                                                      'Row_navigate_to');
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ORIGEN_MOBILE_PAGE_Row_0guuwpj5_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Row_navigate_to');
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ORIGEN_MOBILE_PAGE_Row_zbx1ytu2_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Row_navigate_to');
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'ORIGEN_MOBILE_PAGE_Row_szyl6ht0_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Row_navigate_to');
                                                  ...
                                                  if ((valueOrDefault(
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () async {
                                                          logFirebaseEvent(
                                                              'ORIGEN_MOBILE_PAGE_Row_nuz2sm5t_ON_TAP');
                                                          logFirebaseEvent(
                                                              'Row_navigate_to');
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'ORIGEN_MOBILE_PAGE_Row_60e1ajgj_ON_TAP');
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ORIGEN_MOBILE_PAGE_Icon_bpyzmon8_ON_TAP');
                                    logFirebaseEvent('Icon_drawer');
                                ...
                                Column(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'ORIGEN_MOBILE_PAGE_Icon_l8vhyj8k_ON_TAP');
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  FlutterFlowDropDown<String>(
                                    ...
                                    options: origenMobileDireccionesRecordList
                                        .map((e) => e.alias)
                                        .toList(),
                                    onChanged: (val) async {
                                      setState(
                                      ...
                                      logFirebaseEvent(
                                          'ORIGEN_MOBILE_DropDown_xbnfwcvz_ON_FORM_');
                                      logFirebaseEvent(
                                      ...
                                      setState(() {
                                        _model.origenColoniaValueController
                                                ?.value =
                                            _model.origenCopy!.colonia;
                                      });
                                      logFirebaseEvent(
                                          'DropDown_set_form_field');
                                      setState(() {
                                        _model.origenPaisValueController
                                            ?.value = _model.origenCopy!.pais;
                                      });
                                      logFirebaseEvent(
                                          'DropDown_set_form_field');
                                      setState(() {
                                          ...
                                          child: Padding(
                                            ...
                                            child: TextFormField(
                                              ...
                                              onChanged: (_) =>
                                                ...
                                                () async {
                                                  logFirebaseEvent(
                                                      'ORIGEN_MOBILE_OrigenCodigoPostal_ON_TEXT');
                                                  logFirebaseEvent(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            logFirebaseEvent(
                                                'ORIGEN_MOBILE_PAGE_GUARDAR_BTN_ON_TAP');
                                            logFirebaseEvent(
                                            ...
                                            if (_model.guardarOrigenValue!) {
                                              ...
                                              await DireccionesRecord.collection
                                                ...
                                                'filtros':
                                                    columnConfiguracionLocalRecord!
                                                        .administradoresUuid,
                                              });
                                              logFirebaseEvent(
                                                  'Button_update_app_state');
                                              setState(() {
                                                FFAppState().updateOrigenStruct(
                                                  (e) => e
                                                    ..name = _model
                                                        .origenNombreController
                                                        .text
