...
import 'datos_pagos_mobile_model.dart';
export 'datos_pagos_mobile_model.dart';

class DatosPagosMobileWidget extends StatefulWidget {
  const DatosPagosMobileWidget({Key? key}) : super(key: key);

  @override
  _DatosPagosMobileWidgetState createState() => _DatosPagosMobileWidgetState();
}

class _DatosPagosMobileWidgetState extends State<DatosPagosMobileWidget> {
  late DatosPagosMobileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatosPagosMobileModel());

    // On component load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('DATOS_PAGOS_MOBILE_datosPagosMobile_ON_I');
      if (valueOrDefault(currentUserDocument?.referenciaPago, '') == null ||
          valueOrDefault(currentUserDocument?.referenciaPago, '') == '') {
        logFirebaseEvent('datosPagosMobile_backend_call');
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FlutterFlowIconButton(
                                        ...
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'DATOS_PAGOS_MOBILE_content_copy_ICN_ON_T');
                                          logFirebaseEvent(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'DATOS_PAGOS_MOBILE_ENVIAR_PAGO_BTN_ON_TA');
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'DATOS_PAGOS_MOBILE_COMP_OK_BTN_ON_TAP');
                                          logFirebaseEvent(
                                              'Button_bottom_sheet');
                                          Navigator.pop(context);
                                        },
