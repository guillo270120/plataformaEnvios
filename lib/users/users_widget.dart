...
class _UsersWidgetState extends State<UsersWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('USERS_PAGE_users_ON_INIT_STATE');
      if (!valueOrDefault<bool>(currentUserDocument?.status, false)) {
        logFirebaseEvent('users_alert_dialog');
        await showDialog(
          context: context,
    ...
    return AuthUserStreamWidget(
      builder: (context) => StreamBuilder<List<ConfiguracionLocalRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<ConfiguracionLocalRecord> usersConfiguracionLocalRecordList =
              snapshot.data!;
          final usersConfiguracionLocalRecord =
              usersConfiguracionLocalRecordList.isNotEmpty
                  ? usersConfiguracionLocalRecordList.first
                  : null;
                                                                ...
                                                                Expanded(
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      logFirebaseEvent(
                                                                          'USERS_PAGE_Text_uyl099nv_ON_TAP');
                                                                      logFirebaseEvent(
                                                                          'Text_update_app_state');
                                                                      setState(
                                                                          () {
                                                                        FFAppState().asignarlista =
                                                                            true;
                                                                      });
                                                                    },
                                                                    child: Text(
                                                                      'Lista ${listViewUsersRecord.precio}',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium,
                                                                    ),
                                                              ...
                                                              if (FFAppState()
                                                                ...
                                                                Expanded(
                                                                  child:
                                                                      AsignarlistaWidget(
                                                                    key: Key(
                                                                        'Key60z_${listViewIndex}_of_${listViewUsersRecordList.length}'),
                                                                    userReference:
                                                                        listViewUsersRecord
                                                                            .reference,
                                                                  ),
                                                            ...
                                                            children: [
                                                              ToggleIcon(
                                                                onPressed:
                                                                  ...
                                                                  logFirebaseEvent(
                                                                      'USERS_PAGE_ToggleIcon_c4n31m83_ON_TOGGLE');
                                                                  logFirebaseEvent(
                                                                  ...
                                                                  await showDialog(
                                                                    ...
                                                                    builder:
                                                                        (alertDialogContext) {
                                                                      return AlertDialog(
                                                                        title: Text(!listViewUsersRecord.status
                                                                            ? 'Usuario Activado'
                                                                            : 'Usuario Desactivado'),
                                                                        content: Text(!listViewUsersRecord.status
                                                                            ? 'El usuario ${listViewUsersRecord.displayName} se ha activado con exito.'
                                                                            : 'El usuario ${listViewUsersRecord.displayName} se ha desactivado con exito.'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
